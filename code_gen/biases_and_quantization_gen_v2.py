...
#these to break the arrays just to avoid huge ram consumption of vitis when doing the synthesis
...
general_specs_h_file = '../model_components/basic_defs/general_specs.h'
