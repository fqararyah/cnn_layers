...
#pragma HLS ARRAY_PARTITION variable = _6_layer_6_pw_out_1 complete dim = 1
    ...
    _6_layer_4_pw_5_dw(
     ...
     _7_layer_6_pw(_6_layer_4_5_pw_dw_out_1, pw_weights_4,
                          _6_layer_6_pw_out_1);
    int even_odd = 0;
    int h = 7;
main_pipeline_loop:
    for (; h < switch_point_fms_height; h++)
    {
        if (even_odd)
        {
            ...
            _7_layer_6_pw(_6_layer_4_5_pw_dw_out_1, pw_weights_4,
                          _6_layer_6_pw_out_1);
            _7_layer_7_pw(_6_layer_6_pw_out_0, pw_weights_4,
                          result, h - 7);
        }
        else
        {
            ...
            _6_layer_4_pw_5_dw(
                ...
                _6_layer_5_dw_lower,
                _6_layer_4_5_pw_dw_out_1, 1);
            _7_layer_6_pw(_6_layer_4_5_pw_dw_out_0, pw_weights_4,
                          _6_layer_6_pw_out_0);
    ...
    _6_layer_2_dw(
        ...
        _6_layer_2_dw_out_1,
        0);
    __6_layer_3_pw(_6_layer_2_dw_out_1, pw_weights_2,
                  _6_layer_3_pw_out_1);
    _6_layer_4_pw_5_dw(
        _6_layer_3_pw_out_1,
        pw_weights_3,
    ...
    _6_layer_2_dw(
        ...
        _6_layer_2_dw_out_0,
        0);
    __6_layer_3_pw(_6_layer_2_dw_out_0, pw_weights_2,
                  _6_layer_3_pw_out_0);
    _6_layer_4_pw_5_dw(
        _6_layer_3_pw_out_0,
        pw_weights_3,
