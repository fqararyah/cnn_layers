...
void _7_layer_0_3x3_conv(
    ...
    fms_dt result[layer_2_dw_depth][_7_stages_layer_1_rows_at_once][layer_2_dw_ifm_width])
{
...
void _7_layer_2_dw(
    fms_dt channels_buffer[layer_2_dw_depth][_7_stages_layer_2_rows_at_once][layer_2_dw_ifm_width],
    ...
    fms_dt lower[layer_1_dw_depth][_7_stages_layer_2_rows_at_once][layer_1_dw_ifm_width],
    fms_dt result[layer_3_pw_depth][_7_stages_layer_2_rows_at_once][layer_3_pw_ifm_width], int active_row)
{

#pragma HLS INLINE off
layer_2_dw_main_loop:
    for (int row = 0; row < _7_stages_layer_2_rows_at_once;
         row++)
    {
#pragma HLS UNROLL
        // rows for next DW
        fms_dt intermediate_channels_buffer[][layer_2_dw_filter_size][layer_2_dw_filter_size];
#pragma HLS ARRAY_PARTITION variable = intermediate_channels_buffer type = complete dim = 0
...
void _7_layer_2_pw(
    ...
    fms_dt result[layer_4_pw_depth][_7_stages_layer_1_rows_at_once][layer_5_dw_ifm_width])
{
...
#pragma HLS ARRAY_PARTITION variable = _7_layer_1_dw_lower complete dim = 3
    ...
    fms_dt _7_layer_1_dw_out_0[layer_3_pw_depth][_7_stages_layer_1_rows_at_once][layer_3_pw_ifm_width] = {0};
#pragma HLS ARRAY_PARTITION variable = _7_layer_1_dw_out_0 complete dim = 1
    //##############

    fms_dt _7_layer_3_pw_out_0[layer_4_pw_depth][_7_stages_layer_1_rows_at_once][layer_5_dw_ifm_width] = {0};

    fms_dt _7_layer_5_dw_upper[layer_5_dw_depth][layer_5_dw_ifm_width];
#pragma HLS ARRAY_PARTITION variable = _7_layer_5_dw_upper cyclic factor = layer_4_pw_parallelism_out dim = 1
#pragma HLS ARRAY_PARTITION variable = _7_layer_5_dw_upper cyclic factor = 6 dim = 2

    fms_dt _7_layer_5_dw_lower[layer_5_dw_depth][layer_5_dw_strides][layer_5_dw_ifm_width];
#pragma HLS ARRAY_PARTITION variable = _7_layer_5_dw_lower cyclic factor = 2 dim = 1
#pragma HLS ARRAY_PARTITION variable = _7_layer_5_dw_lower complete dim = 2
#pragma HLS ARRAY_PARTITION variable = _7_layer_5_dw_lower cyclic factor = 12 dim = 3

    fms_dt _7_layer_4_pw_dw_out_0[layer_4_pw_depth][layer_4_pw_ifm_width] = {0};
...
#pragma HLS ARRAY_PARTITION variable = _7_layer_3_pw_out_0 complete dim = 1

#pragma HLS ARRAY_PARTITION variable = _7_layer_4_pw_dw_out_0 cyclic factor = layer_4_pw_parallelism_in/2 dim = 1
    //###########################################################
...
#pragma HLS ARRAY_PARTITION variable = channels_buffer_1 complete dim = 2
    ...
    fms_dt _7_layer_1_dw_out_1[layer_3_pw_depth][_7_stages_layer_1_rows_at_once][layer_3_pw_ifm_width] = {0};
    //##############
    fms_dt _7_layer_3_pw_out_1[layer_4_pw_depth][_7_stages_layer_1_rows_at_once][layer_5_dw_ifm_width] = {0};

    fms_dt _7_layer_4_pw_dw_out_1[layer_4_pw_depth][layer_4_pw_ifm_width] = {0};
...
#pragma HLS ARRAY_PARTITION variable = _7_layer_3_pw_out_1 complete dim = 1

#pragma HLS ARRAY_PARTITION variable = _7_layer_4_pw_dw_out_1 cyclic factor = layer_4_pw_parallelism_in/2 dim = 1
    ...
    for (; h < switch_point_fms_height; h++)
    {
        if (even_odd)
        {
            ...
            _7_layer_4_pw_dw(
                ...
                _7_layer_5_dw_upper,
                _7_layer_5_dw_lower,
                _7_layer_4_pw_dw_out_0, 1);
            _7_layer_4_pw(_7_layer_4_pw_dw_out_1, pw_weights_4,
                          result, h - 6);
        }
        else
        {
            ...
            _7_layer_4_pw_dw(
                ...
                _7_layer_5_dw_lower,
                _7_layer_4_pw_dw_out_1, 1);
            _7_layer_4_pw(_7_layer_4_pw_dw_out_0, pw_weights_4,
                          result, h - 6);
        }
        even_odd = 1 - even_odd;
    }
