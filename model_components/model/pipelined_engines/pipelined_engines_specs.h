...
namespace pipelined_engines
{
    ...
    const int MAX_PW_BUFFER_HEIGHT = PARALLELISM_PW_OFMS;
    ...
    const int DW_PIPE_OVERLAP_BUFFER_DEPTH = 2 * 32 + 2 * 96 + 144 + 144;
