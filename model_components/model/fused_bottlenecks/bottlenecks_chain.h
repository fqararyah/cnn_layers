...
const bottlenecks_chain_specs _1_chain_specs = {
    ...
    bottleneck_1_ofms_height,
    bottleneck_1_ofms_width,
    (bottleneck_1_ofms_depth / pw_tile_d) + ((layer_6_pw_num_fils / pw_tile_d) != 0),
    ...
    bottleneck_1_dw_padding_right,
    bottleneck_1_dw_padding_top,
    bottleneck_1_dw_padding_bottom,
    1,
