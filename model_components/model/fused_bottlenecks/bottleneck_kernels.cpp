...
pss_dt expansion_kernel(fms_dt ifms_buffer[], const int ifms_depth, const weights_dt weights[][16],
                        int filter_index, int h, int w, const int parallelism_w)
{
#pragma HLS INLINE
...
void fill_dw_ifms_buffer_upper_part(fms_dt ifms_buffer[],
...
void fill_dw_ifms_buffer_lower_part(fms_dt ifms_buffer[],
...
dw_pss_dt dw_kernel(fms_dt ifms_buffer[], const dw_weights_dt weights[][max_dw_filter_area_in_a_chain],
...
void projection_kernel(fms_dt ifms_val, const int ofms_depth,
                       const weights_dt weights[][max_of_bottlenecks_layers_depths], pss_dt pss_buffer[],
                       int conv_d)
{
#pragma HLS INLINE
