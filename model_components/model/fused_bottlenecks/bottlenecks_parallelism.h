...
const int bottlenck_0_input_buffer_hw = bottlenck_0_input_buffer_height * bottlenck_0_input_buffer_width;
const int bottlenck_0_input_buffer_size = bottlenck_0_input_buffer_hw * bottleneck_0_ifms_depth;
const int bottlenck_0_output_buffer_size = bottleneck_0_ofms_depth * bottleneck_0_rows_at_once * bottleneck_0_rows_at_once;
const int bottlenck_0_inter_pass_dw_input_width = bottleneck_0_ifms_width / layer_0_s_strides +
                                                  bottleneck_0_dw_padding_left + bottleneck_0_dw_padding_right;
const int bottlenck_0_inter_pass_dw_input_height = (bottleneck_0_dw_filter_dim - bottleneck_0_dw_strides);
const int bottlenck_0_inter_pass_dw_input_size = bottleneck_0_expanded_ifms_depth * bottlenck_0_inter_pass_dw_input_width *
                                                 bottlenck_0_inter_pass_dw_input_height;
//**************************************************************************
...
const int bottlenck_1_inter_pass_dw_input_width = bottleneck_1_ifms_width + bottleneck_1_dw_padding_left + bottleneck_1_dw_padding_right;
const int bottlenck_1_inter_pass_dw_input_size = bottleneck_1_expanded_ifms_depth * bottlenck_1_inter_pass_dw_input_width *
