...
const int bottlenck_0_input_buffer_size = bottleneck_0_expansion_parallelism_h * bottleneck_0_expansion_parallelism_w * bottleneck_0_ifms_depth;
const int bottlenck_0_output_buffer_size = bottleneck_0_ofms_depth * bottleneck_0_ofms_width;
