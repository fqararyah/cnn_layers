...
#if DEBUGGING
 fill_layer_input("/media/SSD2TB/wd/my_repos/DL_Benchmarking/tflite_scripts_imgnt_accuracy_and_weight_extraction/resnet50/fms/ifms_24.txt",
 result, layer_24_s_specs);
#endif
#if DEBUGGING
