...
layer_0_s_3x3(input_image, weights_0, result);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 1, layer_1_dw_depth,
    ...
    layer_1_dw_strides, layer_1_dw_padding_left, layer_1_dw_padding_right, layer_1_dw_padding_top,
    1, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 2, layer_2_pw_depth,
    layer_2_pw_num_fils, layer_2_pw_num_of_tiles_in_d,
    layer_2_pw_num_of_tiles_out_d, layer_2_pw_num_of_tiles_h,
    layer_2_pw_num_of_tiles_w, tmp_channels, 0,
    layer_2_pw_num_of_weight_groups_for_one_pass,
    0, layer_2_pw_weights_offset, layer_2_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 3, layer_3_pw_depth,
    ...
    1, layer_3_pw_weights_offset, layer_3_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 4, layer_4_dw_depth,
    layer_4_dw_ifm_width, layer_4_dw_ifm_height, layer_4_dw_num_of_tiles_in_d,
    layer_4_dw_num_of_tiles_h, layer_4_dw_num_of_tiles_w,
    layer_4_dw_strides, layer_4_dw_padding_left, layer_4_dw_padding_right, layer_4_dw_padding_top,
    0, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 5, layer_5_pw_depth,
    layer_5_pw_num_fils, layer_5_pw_num_of_tiles_in_d,
    layer_5_pw_num_of_tiles_out_d, layer_5_pw_num_of_tiles_h,
    layer_5_pw_num_of_tiles_w, tmp_channels, 2,
    layer_5_pw_num_of_weight_groups_for_one_pass,
    1, layer_5_pw_weights_offset, layer_5_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
