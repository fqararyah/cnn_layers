...
pw_conv(off_chip_weights, channels, result, 8, layer_8_pw_depth,
    ...
    1, layer_8_pw_weights_offset, layer_8_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 9, layer_9_pw_depth,
    ...
    0, layer_9_pw_weights_offset, layer_9_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 10, layer_10_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 11, layer_11_pw_depth,
    ...
    0, layer_11_pw_weights_offset, layer_11_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 12, layer_12_pw_depth,
    ...
    1, layer_12_pw_weights_offset, layer_12_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 13, layer_13_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 14, layer_14_pw_depth,
    ...
    1, layer_14_pw_weights_offset, layer_14_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 15, layer_15_pw_depth,
    ...
    0, layer_15_pw_weights_offset, layer_15_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 16, layer_16_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 17, layer_17_pw_depth,
    ...
    0, layer_17_pw_weights_offset, layer_17_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 18, layer_18_pw_depth,
    ...
    1, layer_18_pw_weights_offset, layer_18_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 19, layer_19_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 20, layer_20_pw_depth,
    ...
    1, layer_20_pw_weights_offset, layer_20_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 21, layer_21_pw_depth,
    ...
    0, layer_21_pw_weights_offset, layer_21_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 22, layer_22_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 23, layer_23_pw_depth,
    ...
    0, layer_23_pw_weights_offset, layer_23_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 24, layer_24_pw_depth,
    ...
    1, layer_24_pw_weights_offset, layer_24_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 25, layer_25_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 26, layer_26_pw_depth,
    ...
    1, layer_26_pw_weights_offset, layer_26_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 27, layer_27_pw_depth,
    ...
    0, layer_27_pw_weights_offset, layer_27_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 28, layer_28_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 29, layer_29_pw_depth,
    ...
    0, layer_29_pw_weights_offset, layer_29_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 30, layer_30_pw_depth,
    ...
    1, layer_30_pw_weights_offset, layer_30_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 31, layer_31_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 32, layer_32_pw_depth,
    ...
    1, layer_32_pw_weights_offset, layer_32_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 33, layer_33_pw_depth,
    ...
    0, layer_33_pw_weights_offset, layer_33_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 34, layer_34_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 35, layer_35_pw_depth,
    ...
    0, layer_35_pw_weights_offset, layer_35_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 36, layer_36_pw_depth,
    ...
    1, layer_36_pw_weights_offset, layer_36_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 37, layer_37_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 38, layer_38_pw_depth,
    ...
    1, layer_38_pw_weights_offset, layer_38_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 39, layer_39_pw_depth,
    ...
    0, layer_39_pw_weights_offset, layer_39_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 40, layer_40_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 41, layer_41_pw_depth,
    ...
    0, layer_41_pw_weights_offset, layer_41_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 42, layer_42_pw_depth,
    ...
    1, layer_42_pw_weights_offset, layer_42_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 43, layer_43_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 44, layer_44_pw_depth,
    ...
    1, layer_44_pw_weights_offset, layer_44_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 45, layer_45_pw_depth,
    ...
    0, layer_45_pw_weights_offset, layer_45_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, result, channels, 46, layer_46_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 47, layer_47_pw_depth,
    ...
    0, layer_47_pw_weights_offset, layer_47_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 48, layer_48_pw_depth,
    ...
    1, layer_48_pw_weights_offset, layer_48_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
dw_conv_3x3(seml_dw_weights_3x3, channels, result, 49, layer_49_dw_depth,
...
pw_conv(off_chip_weights, channels, result, 50, layer_50_pw_depth,
    ...
    1, layer_50_pw_weights_offset, layer_50_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
pw_conv(off_chip_weights, channels, result, 51, layer_51_pw_depth,
    ...
    0, layer_51_pw_weights_offset, layer_51_activation, fused_scales, fused_scales_log_2_shifts, relu_6_fused_scales, fused_zero_points);
// 	//end_code_generation
