...
pw_conv(off_chip_weights, result , channels, tmp_channels, 12, layer_12_pw_specs,
    ...
    model_configs_list);
#if DEBUGGING
 fill_layer_input("/media/SSD2TB/fareed/wd/my_repos/DL_Benchmarking/tflite_scripts_imgnt_accuracy_and_weight_extraction/mob_v2/fms/ifms_14.txt",
 channels, layer_14_dw_specs);
#endif
#if DEBUGGING
 verify_fill_layer_input("/media/SSD2TB/fareed/wd/my_repos/DL_Benchmarking/tflite_scripts_imgnt_accuracy_and_weight_extraction/scratch_out/verify_14.txt",
 channels, layer_14_dw_specs);
#endif
seml_engines::fill_layer_dw_weights_off_chip
