...
const int MAX_CHANNELS_TILE_PADDING = MAX_FILTER_DIM_STRIDE_1 - 1 > (MAX_FILTER_DIM_STRIDE_2 - 1) / 2
										  ? MAX_FILTER_DIM_STRIDE_1 - 1
										  : (MAX_FILTER_DIM_STRIDE_2 - 1) / 2;

const int MAX_PADDING_TOP_LEFT = (MAX_FILTER_DIM_STRIDE_1 - 1);

const int CHANNELS_TILE_DEPTH = 32;
const int CHANNELS_TILE_HEIGHT = MIN_FMS_WIDTH + MAX_CHANNELS_TILE_PADDING;
const int CHANNELS_TILE_WIDTH = MIN_FMS_WIDTH + MAX_CHANNELS_TILE_PADDING;
