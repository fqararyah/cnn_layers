...
#pragma HLS INLINE off
	...
	const int channels_buffer_start_filling_h = first_conv_layer_filter_dim - to_fill_rows_count;
	...
	const int starting_row_in_ofms, const int to_produce_rows_count)
{
	...
	const int starting_row_in_ifms = starting_row_in_ofms * first_conv_layer_strides;
